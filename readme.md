...
`aicli` es un agente de línea de comandos diseñado para ayudar a los desarrolladores a comprender y modificar bases de código complejas. Funciona mediante la contextualización de una pregunta o tarea específica dentro de un repositorio y utiliza un modelo de lenguaje avanzado para proponer soluciones en forma de explicaciones y parches de código.
...
- tools/** : componentes y funciones del agente
- agent.py : comando principal
